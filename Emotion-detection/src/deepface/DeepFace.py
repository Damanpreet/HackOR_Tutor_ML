...
def detectFace(img, detector_backend = 'mtcnn'):
	...
	img, region = functions.preprocess_face(img = img, detector_backend = detector_backend, return_region = True) #preprocess_face returns (1, 224, 224, 3)
	return img[0][:, :, ::-1], region #bgr to rgb
